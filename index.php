...
.engine{position: absolute;text-indent: -2400px;text-align: center;padding: 0;top: 0;left: -2400px;}[class*="-iconfont"]{display: inline-flex;} i{position:fixed;bottom:40px;right:40px;font-size:45px;background: #000000; padding: 7px 10px; border-radius: 50%; cursor: pointer; color: #ffff;}i:hover{background: #0d4aa5; transition: .5s;}</style>
...
<body>
  ...
  <amp-sidebar id="sidebar" class="cid-sizh00o7aw" layout="nodisplay" side="right">
  ...
  <section class="menu horizontal-menu cid-sizh00o7aw" id="menu1-0">
    ...
    <div class="menu-container mbr-jc-s container-fluid">
      ...
      <span align="right" class="login-signup"><a href="logout.php">Logout</a></span>
...
<section class="amp-lightbox-gallery cid-siHgnPT6Bn" id="gallery2-3">
	<div class="container">
		<div class="mbr-row">
                   ...
                   <div class="item-wrapper">
                      <amp-img lightbox="gallery2-3" src="upload/<?php echo $row['file'] ?>" layout="responsive" width="348" height="232" alt="image" class="placeholder-loader lb-image">
                        ...
                        <div class="icon-wrap iconfont-wrapper">
                            <span class="amp-iconfont mobi-mbri-search mobi-mbri">
                        ...
                        <p class="item-sign mbr-fonts-style mbr-bold display-4"><?php echo $row['judul']; ?></p> 
                      </amp-img>
                   </div>
                   <a href="edit.php?id=<?php echo $row['id_gambar'] ?>">Edit</a>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
...
<a href="upload.php"><i class="fas fa-plus"></i></a>
