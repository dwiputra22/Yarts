...
<body><amp-sidebar id="sidebar" class="cid-sizh00o7aw" layout="nodisplay" side="right">
      ...
      <span></span>
       ...
       <!-- NAVBAR ITEMS -->
        <ul class="navbar-nav nav-dropdown mbr-column nav-right" data-app-modern-menu="true"><li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link link text-black display-4" href="account.php"><br></a>
          </li></ul>
        <!-- NAVBAR ITEMS END -->
        <!-- SHOW BUTTON -->
  ...
  <section class="menu horizontal-menu cid-sizh00o7aw" id="menu1-8">
    ...
    <div class="menu-container mbr-jc-s container-fluid">
      ...
      <span class="login-signup"><a href="logout.php">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Logout</a></span>
...
<section class="contacts5 cid-sizqTu2GSY" id="contacts5-a">
    ...
    <div class="container">
        ...
        <div class="mbr-row mbr-jc-c main-row mbr-pt-4">
            <div class="mbr-col-md-12 mbr-col-sm-12 img-content mbr-col-lg-7 md-pb">
                <amp-img src="assets/images/02.jpg" alt="Mobirise" width="633" height="422" layout="responsive" class="mobirise-loader">
                    <div placeholder="" class="placeholder">
                                <div class="mobirise-spinner">
                                    <em></em>
                                    <em></em>
              ...
              <div class="mbr-flex mbr-column content_block">
                ...
                <div class="list-box">
                    <div class="list-item mbr-flex mbr-pb-2">
                        ...
                        <p class="mbr-fonts-style list-item-text display-7">021-522-501</p>
                    </div>
                ...
                <div class="list-item mbr-flex mbr-pb-2">
                        ...
                        <p class="mbr-fonts-style list-item-text display-7">YArts@mail.com</p>
                    </div>
                    ...
                    <div class="list-item mbr-flex last-child">
                        ...
                        <p class="mbr-fonts-style list-item-text display-7">Jl. Perbanas, Kuningan, Karet Kuningan, Kecamatan Setiabudi, Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12940</p>
                    </div>
